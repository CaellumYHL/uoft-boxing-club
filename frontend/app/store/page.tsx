        ...
        <div className="flex justify-center gap-12 mb-16">
          {memberships.map((item) => (
            <Link href={`/store/${item.id}`} key={item.id} className="group flex flex-col items-center">
              <div className="w-64 h-64 bg-secondary rounded-xl mb-4 group-hover:bg-blue-400 transition cursor-pointer shadow-lg shadow-blue-900/20"></div>
        ...
        <div className="flex justify-center gap-12 flex-wrap">
          {merch.map((item) => (
            <Link href={`/store/${item.id}`} key={item.id} className="group flex flex-col items-center">
              ...
              <div className="w-56 h-56 bg-secondary rounded-xl mb-4 group-hover:bg-blue-400 transition cursor-pointer shadow-lg shadow-blue-900/20"></div>
